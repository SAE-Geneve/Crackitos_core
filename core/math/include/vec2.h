...
namespace crackitos_core::math
{
    ...
    struct Vec2
    {
        ...
        [[nodiscard]] constexpr Vec2 CrossProduct(const Vec2& v1, crackitos_core::commons::fp s) const
        {
            return Vec2(s * v1.y, -s * v1.x);
        }

        [[nodiscard]] constexpr Vec2 CrossProduct(crackitos_core::commons::fp s, const Vec2& v1) const
        {
            return Vec2(-s * v1.y, s * v1.x);
        }
    ...
    using Vec2f = Vec2<crackitos_core::commons::fp>;
