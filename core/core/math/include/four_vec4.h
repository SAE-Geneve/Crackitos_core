...
namespace crackitos_core::math
{
    ...
    struct FourVec4
    {
        ...
        FourVec4<T> operator*(const crackitos_core::commons::fp scalar) const; //Multiply by scalar
        FourVec4<T> operator/(const crackitos_core::commons::fp scalar) const; //Divide by scalar
        std::array<crackitos_core::commons::fp, 4> Dot(const FourVec4<T>& other) const; //Dot
    ...
    using FourVec4f = FourVec4<crackitos_core::commons::fp>;

    //Specialization for physics923::commons::fp
    template <>
    FourVec4f FourVec4<crackitos_core::commons::fp>::operator+(const FourVec4f& other) const;
    template <>
    FourVec4f FourVec4<crackitos_core::commons::fp>::operator-(const FourVec4f& other) const;
    template <>
