...
namespace crackitos_core::math
{
    ...
    struct Vec4fOperatorFixture :
        public testing::TestWithParam<std::pair<Vec4<crackitos_core::commons::fp>, Vec4<crackitos_core::commons::fp>>>
    {
    };
    ...
    {
        auto [v1, v2] = GetParam();
        const auto result = Vec4<crackitos_core::commons::fp>::Dot(v1, v2);
    ...
    INSTANTIATE_TEST_SUITE_P(AllNumbers, Vec4fOperatorFixture,
                             testing::Values(
                                 ...
                                 std::pair{math::Vec4<crackitos_core::commons::fp>{}, math::Vec4<crackitos_core::commons::fp>{} },
                                 std::pair{ math::Vec4{1.5f, 5.1f, 2.8f, 1.2f}, math::Vec4<crackitos_core::commons::fp>{} },
                                 std::pair{math::Vec4<crackitos_core::commons::fp>{}, math::Vec4{1.9f, 7.6f, 3.3f, 1.4f} }
                             )
    );
}