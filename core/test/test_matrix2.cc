...
namespace crackitos_core::math
{
    ...
    {
        matrix2<crackitos_core::commons::fp> mat1{{1, 2}, {3, 4}};
        matrix2<crackitos_core::commons::fp> mat2{{5, 6}, {7, 8}};
    ...
    {
        matrix2<crackitos_core::commons::fp> mat1{{5, 6}, {7, 8}};
        matrix2<crackitos_core::commons::fp> mat2{{1, 2}, {3, 4}};
        auto result = mat1 - mat2;
    ...
    {
        matrix2<crackitos_core::commons::fp> mat{{1, 2}, {3, 4}};
    ...
    {
        matrix2<crackitos_core::commons::fp> mat{{1, 2}, {3, 4}};
        Vec2<crackitos_core::commons::fp> vec{2, 3};
        auto result = mat * vec;
    ...
    {
        auto rotation = math::matrix2<crackitos_core::commons::fp>().rotation(static_cast<crackitos_core::commons::fp>(std::numbers::pi_v<crackitos_core::commons::fp> / 2));
